        ...
        <section id="experience" className="py-20 md:py-28 bg-background">
            <div className="container mx-auto px-4">
                <div className="text-center mb-12 md:mb-16">
                    ...
                    <p className="text-muted-foreground mt-4 max-w-2xl mx-auto text-base md:text-lg">My professional journey and key accomplishments.</p>
                </div>
                <div className="relative max-w-4xl mx-auto">
                    <div className="absolute left-4 md:left-1/2 -translate-x-1/2 h-full w-0.5 bg-border/50"></div>
                    {experiences.map((exp, index) => (
                        <div key={index} className="relative pl-12 md:pl-0 mb-12">
                            <div className="absolute left-4 md:left-1/2 -translate-x-1/2 -translate-y-1/2 top-0 mt-1.5">
                                <div className="w-8 h-8 rounded-full bg-secondary border-4 border-primary flex items-center justify-center">
                                  <Briefcase className="h-4 w-4 text-primary-foreground" />
                                </div>
                            </div>
                            <div className={`flex md:items-center ${index % 2 === 0 ? 'md:justify-start' : 'md:justify-end'} `}>
